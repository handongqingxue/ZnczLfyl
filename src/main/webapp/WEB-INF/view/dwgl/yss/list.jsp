	...
	tab1=$("#tab1").datagrid({
		...
		columns:[[
            ...
            {field:"id",title:"操作",width:150,formatter:function(value,row){
            	var str="<a href=\""+dwglPath+"dwgl/yss/detail?fnid="+'${param.fnid}'+"&snid="+'${param.snid}'+"&id="+value+"\">详情</a>"
            	+"&nbsp;|&nbsp;<a href=\""+dwglPath+"dwgl/yss/edit?fnid="+'${param.fnid}'+"&snid="+'${param.snid}'+"&id="+value+"\">修改</a>";
            	return str;
            }}
	    ]],
...
function deleteByIds() {
	...
	$.messager.confirm("提示","确定要删除吗？",function(r){
		if(r){
			...
			$.post(dwglPath + "deleteYuShuShang",
				{ids:ids},
				function(result){
					if(result.status==1){
						alert(result.msg);
