		...
		<div id="new_div">
			...
			<table>
			  <tr>
				...
				<td class="td2">
					<input type="text" id="mc" name="mc" placeholder="请输入类名" style="width: 150px;height:30px;" onfocus="focusMC()" onblur="checkMC()"/>
				</td>
				<td class="td1" align="right">
					排序
				</td>
				<td class="td2">
					<input type="number" id="px" name="px" style="width: 150px;height:30px;"/>
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
