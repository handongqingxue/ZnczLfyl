		...
		function(result){
			...
			wzlxCBB=$("#edit_div #wzlx_cbb").combobox({
				...
				onLoadSuccess:function(){
					$(this).combobox("setValue",'${requestScope.wz.wzlxId }');
				}
			});
		}
	,"json");
...
<div class="layui-layout layui-layout-admin">
	...
	<div class="center_con_div" id="center_con_div">
		<div class="page_location_div">物资查询-编辑</div>
		...
		<div id="edit_div">
			...
			<table>
			  <tr>
				...
				<td class="td2">
					<input type="text" class="mc_inp" id="mc" name="mc" value="${requestScope.wz.mc }" placeholder="请输入名称" onfocus="focusMC()" onblur="checkMC()"/>
				</td>
				<td class="td1" align="right">
					物资类型
				</td>
				<td class="td2">
					<input id="wzlx_cbb"/>
					<input type="hidden" id="wzlxId" name="wzlxId" value="${requestScope.wz.wzlxId }"/>
				</td>
			  </tr>
			  <tr>
				<td class="td1" align="right">
