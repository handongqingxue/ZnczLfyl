...
public interface GuoBangJiLuMapper {
	...
	int queryJYJLForInt(@Param("ddh") String ddh, @Param("ddztMc") String ddztMc, @Param("sjxm") String sjxm, @Param("sjsfzh") String sjsfzh, @Param("cph") String cph, @Param("yssMc") String yssMc, @Param("fhdwMc") String fhdwMc, @Param("shbmMc") String shbmMc, @Param("gbsjks") String gbsjks, @Param("gbsjjs") String gbsjjs);

	List<GuoBangJiLu> queryJYJLList(@Param("ddh") String ddh, @Param("ddztMc") String ddztMc, @Param("sjxm") String sjxm, @Param("sjsfzh") String sjsfzh, @Param("cph") String cph, @Param("yssMc") String yssMc, @Param("fhdwMc") String fhdwMc, @Param("shbmMc") String shbmMc, @Param("gbsjks") String gbsjks, @Param("gbsjjs") String gbsjjs, @Param("rowNum") int rowNum, @Param("rows") int rows, String sort,
			String order);
}
